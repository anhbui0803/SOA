# Generated by Django 4.0.3 on 2024-04-08 17:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=django.utils.timezone.now)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservationApp.busbrand')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=100)),
                ('name', models.CharField(max_length=250)),
                ('pay_type', models.CharField(choices=[('1', 'Cash'), ('2', 'Card')], default=1, max_length=2)),
                ...
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('bus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservationApp.bus')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reservationApp.category')),
